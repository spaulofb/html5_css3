...
<head>
    ...
    <title>Capítulo 14 - Cores Gradiente em CSS - cor02.php </title>
<style>
* { 
       height: 100%;
}
    ...
    body {
        ...
        /****     background-image: linear-gradient(to bottom,  #F20587, #F205E2, #960CF2, #F29F05, #F24607); 
        *   background-image: linear-gradient(to right,  #F20587, #F205E2, #960CF2, #F29F05, #F24607);
        *    background-image: linear-gradient(-45deg,  #F20587, #F205E2, #960CF2, #F29F05, #F24607);
        *     background-image: radial-gradient(circle,  #F20587, #F205E2, #960CF2, #F29F05, #F24607); 
        ****/
         background-image: linear-gradient(to right, #960CF2 80%,  #F20587, #F205E2,  #F29F05, #F24607);
...
<h2 style="background-color: #141F87; color:#ffffff;" >Exemplo de Cores</h2>
...
<!-- Representação por características de cores - HSL (Hue, Sturation e Luminosity)   -->
<!-- Representação por características de cores - HSL (Matix, Saturacao e Luminosidade)   -->
<h2 style="background-color: hsl(240,100%,50%); color: hsl(0,0%,100%);"  >Exemplo de Cores</h2>
<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat unde commodi, ullam quisquam ducimus possimus tempora vel, a quo necessitatibus error quis totam ea! Consequatur quisquam ipsum atque vel doloremque.</p>


    <!-- Representação por Nomes  -->
    <h2 style="background-color: rgb(165, 83, 64);color: white;" >Exemplo de Cores</h2>
<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias tenetur, dolor tempore necessitatibus ab, vel beatae consequatur a alias qui, saepe nemo deserunt numquam maxime. In inventore repellat libero vitae.</p>
